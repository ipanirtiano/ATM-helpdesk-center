                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <form action="<?= base_url(); ?>/karyawan/proses_update/<?= $kodeUser; ?>" method="post">
                                    <?= csrf_field() ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-check-inline mt-1">
                                                <input class="form-check-input <?= ($validation->hasError('level') ? 'is-invalid' : ''); ?>" type="radio" name="level" id="inlineRadio1" value="Admin" <?= $level['level'] == 'Admin' ? 'checked' : '' ?>>
                                                <label class="form-check-label" for="inlineRadio1" style="font-size:14px;">Admin</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input <?= ($validation->hasError('level') ? 'is-invalid' : ''); ?>" type="radio" name="level" id="inlineRadio2" value="Teknisi" <?= $level['level'] == 'Teknisi' ? 'checked' : '' ?>>
                                                <label class="form-check-label" for="inlineRadio2" style="font-size:14px;">Teknisi</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input <?= ($validation->hasError('level') ? 'is-invalid' : ''); ?>" type="radio" name="level" id="inlineRadio2" value="Respon Handler" <?= $level['level'] == 'Respon Handler' ? 'checked' : '' ?>>
